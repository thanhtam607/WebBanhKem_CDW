...
class CheckOut extends Component {
  ...
  handlePlaceOrder = async () => {
    this.checkInfoNull();
    const errorsNull = Object.values(this.state.error).every(
      (error) => error === null
    );
    ...
    if (errorsNull) {
      ...
      this.handleDeleteCart(
        this.props.user.carts.filter((item) => item.status === 1)
      );
      Swal.fire({
  ...
  handleDeleteCart = async (cartsSelect) => {
    for (const item of cartsSelect) {
      ...
      if (res.errCode === 0) {
        const carts = this.props.user.carts.filter(
  ...
  render() {
    ...
    const { selectedPaymentMethod, error, listDistricts, listWards } =
      this.state;
                ...
                <div className="col-md-12 col-lg-6 col-xl-7">
                  <div className="form-item">
                    ...
                    <input
                      ...
                      value={this.state.billingInfo.fullname}
                      onChange={(e) =>
                  ...
                  <div className="form-item">
                    ...
                    <input
                      ...
                      onChange={(e) => this.handleChangeInput(e, "addDetail")}
                    />
                  ...
                  <div className="form-item">
                    ...
                    >
                      <option selected={true} value="TP HCM">
                        TP HCM
                      </option>
                  ...
                  <div className="form-item">
                    ...
                    <select
                      ...
                      onChange={(e) => this.handleChangeInput(e, "district")}
                    >
                      <option value="" disabled selected hidden>
                        Chọn quận/huyện
                      </option>
                      {listDistricts.map((item) => (
                        <option value={item.name} data-name={item.code}>
                          {item.name}
                        </option>
                      ))}
                  ...
                  <div className="form-item">
                    ...
                    <select
                      ...
                      onChange={(e) => this.handleChangeInput(e, "ward")}
                    >
                      <option value="" disabled selected hidden>
                        Chọn phường/xã
                      </option>
                  ...
                  <div className="form-item">
                    ...
                    <input
                      type="tel"
                      value={this.state.billingInfo.phone_number}
                      className="form-control"
                      onChange={(e) =>
                ...
                <div className="col-md-12 col-lg-6 col-xl-5">
                  ...
                  <div className="row g-4 text-center align-items-center justify-content-center border-bottom py-3">
                    <div className="col-12">
                      <h4 className="text-primary-cake text-left">
                      ...
                      <div className="form-check text-start my-3">
                        <label className="form-check-label" id="Payments-1">
                          ...
                          <input
                            ...
                            onChange={() =>
                              this.handlePaymentMethodChange("credit_card", 1)
                            }
                          />
                        </label>
                      </div>
                      <div className="form-check text-start my-3">
                        <label className="form-check-label" id="Payments-2">
                          ...
                          <input
                            ...
                            onChange={() =>
                              this.handlePaymentMethodChange("cash", 2)
                            }
                          />
                        </label>
                      </div>
                    ...
                    <div className="col-12">
                      <div className="flex-container">
                        ...
                        <p className="flex-item">
                          {this.state.billingInfo.pro_bill} VND
                        </p>
                      </div>
                      <div className="flex-container">
                        <p className="flex-item">Phí giao hàng:</p>
                        <p className="flex-item">
                          {this.state.billingInfo.fee_bill}
                        </p>
                      </div>
                      <div className="flex-container">
                        <p className="flex-item">Tổng thanh toán:</p>
                        <p className="flex-item">
                          {this.state.billingInfo.pro_bill +
                            this.state.billingInfo.fee_bill}{" "}
                          VND
                        </p>
                      </div>
                  ...
                  <div className="row g-4 text-center align-items-center justify-content-center pt-4">
                    <button
                      ...
                      className="btn bg-primary-cake border-secondary text-uppercase w-100 text-white"
                    >
                      Đặt hàng
                    </button>
                  </div>
  ...
  checkInfoNull = () => {
    ...
    const checks = [
      ...
      },
      {
        condition: !ward,
        errorKey: "erWard",
        errorMsg: "Vui lòng chọn xã/phường.",
      },
      {
        condition: !email,
        errorKey: "erEmail",
